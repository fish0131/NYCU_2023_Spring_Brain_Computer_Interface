...
if os.name == "nt":
    ...
    print("path: ", basepath)
    ctypes.cdll.LoadLibrary(os.path.join(basepath, 'core', 'libmmd.dll'))
    ctypes.cdll.LoadLibrary(os.path.join(basepath, 'core', 'libifcoremd.dll'))
